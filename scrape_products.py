# scrape_marketplace_products.py
import csv
import time
...
# ----------------- EBAY (FIXED) ----------------- #
# Uses your screenshot: active carousel image + fallback
...
def scrape_ebay(page, url):
    ...
    # Title fallback based on screenshot
    if not title:
        selectors = [
...
def main():
    ...
    with open(OUTPUT_CSV, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(f, fieldnames=[
            ...
            "Product_Title", "Image_URL_1", "Image_URL_2",
